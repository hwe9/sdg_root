        ...
        for json_file_name in json_files:
            try:
                ...
                if doi_match:
                    ...
                    # Hier müsste die Logik zur Extraktion des Symbols stehen
                    symbol = "E/2023/1"
                    api_metadata = api_client.get_metadata_from_un_digital_library(symbol)
                elif oecd_match:
                    # Hier müsste die Logik zur Extraktion der Dataset-ID stehen
                    dataset_id = "EDU_ENRL"
                    api_metadata = api_client.get_metadata_from_oecd(dataset_id)
                elif wb_match:
                    # Hier müsste die Logik zur Extraktion der Indikator-ID stehen
